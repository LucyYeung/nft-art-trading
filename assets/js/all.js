...
$(".search, .search-back").on("click", function () {
...
num.forEach(function (value) {
  $(".ranking-btn-".concat(value)).on("click", function (e) {
    $(".ranking-btn-".concat(value)).toggleClass("corner-black-lg corner-primary-lg");
    $(e.target.parentNode).find("i").toggleClass("fa-minus fa-plus");
    $(".ranking-info-".concat(value)).toggle("hidden");
  });
});
...
$(".grid-masonry").on("load", function (e) {
  var grid = document.querySelector(".grid-masonry");
  var msnry = new Masonry(grid, {
    // options
    percentPosition: true
...
(function () {
  ...
  var Default = {
    alwaysOpen: false,
    activeClasses: "bg-gray-100 text-darkGray dark:text-white",
